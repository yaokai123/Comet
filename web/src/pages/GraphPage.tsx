...
const KIND_META: Record<string, { label: string; color: string }> = {
  Entity: { label: '实体', color: '#b7791f' },
  Event: { label: '事件', color: '#c46b3c' },
  Statement: { label: '陈述', color: '#287a55' },
  Chunk: { label: '片段', color: '#8b6b3f' },
  Dialogue: { label: '对话', color: '#4d6b6a' },
}
...
export default function GraphPage() {
  ...
  return (
    <div className="graph-workspace" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <Card
              ...
              <ForceGraph2D
                ...
                linkColor={(l) =>
                  highlightLinks.current.has(l as FGLink)
                    ...
                    : (l as FGLink).rel === 'RELATION'
                      ? 'rgba(141, 113, 70, 0.52)'
                      : 'rgba(187, 170, 138, 0.42)'
                }
                ...
                nodeCanvasObject={(node, ctx, globalScale) => {
                  ...
                  if (globalScale > 0.7 || r > 9) {
                    ...
                    ctx.fillStyle = dim ? 'rgba(43,36,26,0.25)' : '#2b241a'
