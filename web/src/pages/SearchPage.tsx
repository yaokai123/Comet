...
export default function SearchPage() {
  ...
  return (
    <div className="fluid-page operations-page search-workspace">
      <Input.Search
      ...
      {loading ? (
        ...
        <Empty className="search-empty-state" description="输入关键词，一次搜遍知识库、图片与记忆" />
      ) : (
...
function ResultColumn({
  ...
  return (
    <div className="search-result-column">
      <div className="search-result-column__title">
