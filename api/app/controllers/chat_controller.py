...
async def create_conversation(
    ...
    service = ConversationService(session)
    conv = await service.create(user.id, body.title, body.project_id or project_id)
...
async def chat_stream(
    ...
    return StreamingResponse(
        service.stream_chat(user.id, body.model_copy(update={"project_id": body.project_id or project_id})),
